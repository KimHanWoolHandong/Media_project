...
def calculation_collection(pos_dic, neg_dic, komoran):
    NTW_news, NTW_count, NTW_average = calculate_csv('./NTW.csv', pos_dic, neg_dic, komoran)
    KYS_news, KYS_count, KYS_average = calculate_csv('./KYS.csv', pos_dic, neg_dic, komoran)
    KDJ_news, KDJ_count, KDJ_average = calculate_csv('./KDJ.csv', pos_dic, neg_dic, komoran)
    NMH_news, NMH_count, NMH_average = calculate_csv('./NMH.csv', pos_dic, neg_dic, komoran)
    LMB_news, LMB_count, LMB_average = calculate_csv('./LMB.csv', pos_dic, neg_dic, komoran)
    PKH_news, PKH_count, PKH_average = calculate_csv('./PKH.csv', pos_dic, neg_dic, komoran)
    MJI_news, MJI_count, MJI_average = calculate_csv('./MJI.csv', pos_dic, neg_dic, komoran)

    write_csv('NTW', NTW_news, NTW_count, NTW_average)
    write_csv('KYS', KYS_news, KYS_count, KYS_average)
    write_csv('KDJ', KDJ_news, KDJ_count, KDJ_average)
    write_csv('NMH', NMH_news, NMH_count, NMH_average)
    write_csv('LMB', LMB_news, LMB_count, LMB_average)
    write_csv('PKH', PKH_news, PKH_count, PKH_average)
    write_csv('MJI', MJI_news, MJI_count, MJI_average)
